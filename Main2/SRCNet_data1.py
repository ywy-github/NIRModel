...
if __name__ == '__main__':
    ...
    train_benign_data = MyData("../data/二期数据CLAHE/train/wave1/benign", "benign", transform=transform)
    train_malignat_data = MyData("../data/二期数据CLAHE/train/wave1/malignant", "malignant", transform=transform)
    train_data = train_benign_data + train_malignat_data

    val_benign_data = MyData("../data/二期数据CLAHE/val/wave1/benign", "benign", transform=transform)
    val_malignat_data = MyData("../data/二期数据CLAHE/val/wave1/malignant", "malignant", transform=transform)
    val_data = val_benign_data + val_malignat_data

    test_benign_data = MyData("../data/二期数据CLAHE/test/wave1/benign", "benign", transform=transform)
    test_malignat_data = MyData("../data/二期数据CLAHE/test/wave1/malignant", "malignant", transform=transform)
    ...
    criterion = WeightedBinaryCrossEntropyLoss(0.6)
