...
from evaluation.model_evaluation import compute
...
if __name__ == '__main__':
    ...
    extendModel.load_state_dict(torch.load('../models2/Vq-VAE-resnet18仅重构+分类器/Vq-VAE-resnet18仅重构+分类器-71.pth'))
    ...
    compute(test_targets,test_pred,test_score)

    # df = pd.DataFrame(test_results)
    # filename = '../models1/result/VQ-VAE-resnet18-二期双十+双十五训-双十测.xlsx'
    #
    # # 检查文件是否存在
