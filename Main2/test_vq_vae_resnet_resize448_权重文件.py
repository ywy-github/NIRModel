...
if __name__ == '__main__':
    ...
    test_benign_data = MyData("../data/二期双十+双十五/test/wave1/benign", "benign", transform=transform)
    test_malignat_data = MyData("../data/二期双十+双十五/test/wave1/malignant", "malignant", transform=transform)
    ...
    # filename = '../excels/MixUp/一期数据.xlsx'
    #
    # # 检查文件是否存在
