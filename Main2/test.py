...
# 定义联合模型的损失函数
def joint_loss_function(recon_loss, vq_loss, classifier_loss,adaptation_loss ,
                        lambda_recon, lambda_vq, lambda_classifier, lambda_adaptation):
    # 总损失
