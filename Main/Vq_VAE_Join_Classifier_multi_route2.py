...
class Encoder(nn.Module):
    def __init__(self):
        ...
        self.path1 = nn.Sequential(
            nn.Conv2d(in_channels=1, out_channels=64, kernel_size=11, stride=1, padding=5),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2),
            nn.Conv2d(in_channels=64, out_channels=128, kernel_size=11, stride=1, padding=5),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2),
            nn.Conv2d(in_channels=128, out_channels=256, kernel_size=11, stride=1, padding=5),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2),
            nn.Conv2d(in_channels=256, out_channels=512, kernel_size=11, stride=1, padding=5),
            nn.ReLU(),
            nn.MaxPool2d(kernel_size=3, stride=2),
        )
...
class Model(nn.Module):
    def __init__(self,num_embeddings, embedding_dim, commitment_cost, decay=0):
        ...
        self.classifier = Classifier(512*5*7,512,1)
