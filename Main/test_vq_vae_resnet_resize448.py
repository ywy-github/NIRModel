...
if __name__ == '__main__':
    ...
    test_benign_data = MyData("../data/一期数据/new_train/benign", "benign", transform=transform)
    test_malignat_data = MyData("../data/一期数据/new_train/malignant", "malignant", transform=transform)
    ...
    model = torch.load("../models/VQ-Resnet/VQ-VAE-resnet18-resize448+clahe+加入训练集-20.pth", map_location=device)
