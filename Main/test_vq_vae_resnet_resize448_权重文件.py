...
if __name__ == '__main__':
    ...
    test_benign_data = MyData("../data/ti_二期数据/train/benign", "benign", transform=transform)
    test_malignat_data = MyData("../data/ti_二期数据/train/malignant", "malignant", transform=transform)
    ...
    model.load_state_dict(torch.load('../models/argument/VQ-VAE-resnet18-ti-双十+双十五-67.pth'))
