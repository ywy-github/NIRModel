...
if __name__ == '__main__':
    ...
    test_benign_data = MyData("../data/ti_一期数据/test/benign", "benign", transform=transform)
    test_malignat_data = MyData("../data/ti_一期数据/test/malignant", "malignant", transform=transform)
    ...
    model.load_state_dict(torch.load('../models/argument/VQ-VAE-resnet18-mixup一-71.pth'))
