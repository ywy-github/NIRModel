...
class Decoder(nn.Module):
    def __init__(self):
        ...
        self.deconv1 = nn.Sequential(
            nn.ConvTranspose2d(256, 128, kernel_size=1, stride=2, padding=1),
            nn.ReLU(),
...
class Model(nn.Module):
    def __init__(self,encoder,num_embeddings, embedding_dim, commitment_cost, decay=0):
        ...
        self.classifier = Classifier(256*6*6,256,1)
...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        ...
        if ((epoch + 1)%50 == 0):
            torch.save(model, "../models/VQ-AlexNet/VQ-AlexNet{}.pth".format(epoch + 1))
