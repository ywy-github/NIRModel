...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv2 = MSFEblock(planes, atrous_rates=[2, 4, 8])
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=1000, zero_init_residual=False,
        ...
        self.SKConv1 = SKConv(128)
        self.SKConv2 = SKConv(256)
        self.SKConv3 = SKConv(512)
...
class MSFSSLModel(nn.Module):
    def __init__(self,encoder,num_embeddings, embedding_dim, commitment_cost, decay=0):
        ...
        self.classifier = Classifier(512*14*14,2048,1)
...
if __name__ == '__main__':
    ...
    for epoch in range(epochs):
        ...
        #     torch.save(model.state_dict(),"../models消融一期/qc/VQ-VAE-resnet18-qc-二期双十+双十五-{}.pth".format(epoch + 1))
