...
from Main1.data_loader import MyData, TreeChannels
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('../models1/qc/单路径-原始图相减-37.pth'))
    ...
    # filename = '../models1/result/VQ-VAE-resnet18-二期双十+双十五.xlsx'
    #
    # # 检查文件是否存在
