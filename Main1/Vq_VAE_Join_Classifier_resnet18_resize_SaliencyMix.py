...
if __name__ == '__main__':
    ...
    val_benign_data = MyData("../data/ti_一期数据/train/benign", "benign", transform=transform)
    val_malignat_data = MyData("../data/ti_一期数据/train/benign", "benign", transform=transform)
    ...
    for epoch in range(epochs):
        ...
        #     torch.save(model.state_dict(), "../models消融一期/qc/VQ-VAE-resnet18-qc-二期双十-{}.pth".format(epoch + 1))
