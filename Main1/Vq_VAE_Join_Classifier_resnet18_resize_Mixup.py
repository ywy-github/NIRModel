...
if __name__ == '__main__':
    ...
    val_benign_data = MyData("../data/二期双十+双十五/train/wave1/benign", "benign", transform=transform)
    val_malignat_data = MyData("../data/二期双十+双十五/train/wave1/malignant", "malignant", transform=transform)
    val_data = val_benign_data + val_malignat_data

    test_benign_data = MyData("../data/二期双十+双十五/train/wave1/benign", "benign", transform=transform)
    test_malignat_data = MyData("../data/二期双十+双十五/train/wave1/malignant", "malignant", transform=transform)
