...
if __name__ == '__main__':
    ...
    val_benign_data = MyData("../data/二期双十/train/benign", "benign", transform=transform)
    val_malignat_data = MyData("../data/二期双十/train/benign", "benign", transform=transform)
    ...
    for epoch in range(epochs):
        ...
        if ((epoch + 1)%50 == 0):
            torch.save(model, "../models消融一期/result/VQ-VAE-resnet18-data2-双十-Resize微调-{}.pth".format(epoch + 1))
